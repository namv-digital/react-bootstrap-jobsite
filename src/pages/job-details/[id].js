...
export default function JobDetails (){
  ...
  React.useEffect(() => {
    ...
    const url = `https://api.kuratedao.xyz/row/1/${id}`;
    ...
    const fetchData = async () => {
      try {
        ...
        console.log(data)
        setSelectedItem(JSON.parse(data.json))
      } catch (error) {
                ...
                <div className="bg-white rounded-4 border border-mercury shadow-9">
                      ...
                      <div className="col-md-6">
                        ...
                        <div className="media align-items-center">
                          ...
                          <div className="square-72 d-block mr-8">
                            <img src={ selectedItem.company_url } alt="" />
                          </div>
                          {/* <!-- media logo end --> */}
                          {/* <!-- media texts start --> */}
                          <div>
                      ...
                      <div className="col-md-6 text-right pt-7 pt-md-0 mt-md-n1">
                        ...
                        <div className="media justify-content-md-end">
                          <p className="font-size-4 text-gray mb-0">
                            posted {dayjs(selectedItem.datetime).format("MMM D, YYYY")}
                          </p>
                        </div>
                        {/* <!-- media date end --> */}
                      </div>
                  ...
                  <div className="job-details-content pt-8 pl-sm-9 pl-6 pr-sm-9 pr-6 pb-10 border-bottom border-width-1 border-default-color light-mode-texts">
                    <div className="row mb-7">
                      <div className="col-md-5 mb-md-0 mb-6">
                        <div className="media justify-content-md-start">
                          ...
                          <p className="font-weight-semibold font-size-5 text-black-2 mb-0">
                            {selectedItem.salary_low}k-{selectedItem.salary_high}k USD
                          </p>                          
                        </div>
                        <br/>
                        <div className="media justify-content-md-start">
                      ...
                      <div className="col-md-6 pr-lg-0 pl-lg-10 mb-md-0 mb-6">
                        <div className="media justify-content-md-start">
                          <div className="image mr-5">
